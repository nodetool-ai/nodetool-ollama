...
class ChartGenerator(GraphNode):
    ...
    SeabornPlotType: typing.ClassVar[type] = nodetool.metadata.types.SeabornPlotType
    model: types.LlamaModel | GraphNode | tuple[GraphNode, str] = Field(default=types.LlamaModel(type='llama_model', name='', repo_id='', modified_at='', size=0, digest='', details={}), description='The Llama model to use for chart generation.')
    ...
    plot_type: nodetool.metadata.types.SeabornPlotType = Field(default=nodetool.metadata.types.SeabornPlotType.LINE, description='The type of plot to generate')
    data: types.DataframeRef | GraphNode | tuple[GraphNode, str] = Field(default=types.DataframeRef(type='dataframe', uri='', asset_id=None, data=None, columns=None), description='The data to visualize')
    ...
    columns: types.RecordType | GraphNode | tuple[GraphNode, str] = Field(default=types.RecordType(type='record_type', columns=[]), description='The columns available in the data.')
...
class Classifier(GraphNode):
    ...
    model: types.LlamaModel | GraphNode | tuple[GraphNode, str] = Field(default=types.LlamaModel(type='llama_model', name='', repo_id='', modified_at='', size=0, digest='', details={}), description='The Llama model to use for classification.')
    context_window: int | GraphNode | tuple[GraphNode, str] = Field(default=4096, description='The context window size to use for the model.')
...
class DataExtractor(GraphNode):
    ...
    model: types.LlamaModel | GraphNode | tuple[GraphNode, str] = Field(default=types.LlamaModel(type='llama_model', name='', repo_id='', modified_at='', size=0, digest='', details={}), description='The Llama model to use.')
    context_window: int | GraphNode | tuple[GraphNode, str] = Field(default=4096, description='The context window size to use for the model.')
    ...
    json_schema: types.JSONRef | GraphNode | tuple[GraphNode, str] = Field(default=types.JSONRef(type='json', uri='', asset_id=None, data=None), description='The JSON schema that defines the structure of the output. Must be an object type.')
...
class DataGenerator(GraphNode):
    ...
    top_p: float | GraphNode | tuple[GraphNode, str] = Field(default=0.95, description='The cumulative probability cutoff for nucleus/top-p sampling.')
    keep_alive: int | GraphNode | tuple[GraphNode, str] = Field(default=300, description='The number of seconds to keep the model alive.')
    columns: types.RecordType | GraphNode | tuple[GraphNode, str] = Field(default=types.RecordType(type='record_type', columns=[]), description='The columns to use in the dataframe.')
...
class RegressionAnalyst(GraphNode):
    ...
    model: types.LlamaModel | GraphNode | tuple[GraphNode, str] = Field(default=types.LlamaModel(type='llama_model', name='', repo_id='', modified_at='', size=0, digest='', details={}), description='The Llama model to use for regression analysis.')
    context_window: int | GraphNode | tuple[GraphNode, str] = Field(default=4096, description='The context window size to use for the model.')
    ...
    data: types.DataframeRef | GraphNode | tuple[GraphNode, str] = Field(default=types.DataframeRef(type='dataframe', uri='', asset_id=None, data=None, columns=None), description='The dataframe to perform regression on.')
    temperature: float | GraphNode | tuple[GraphNode, str] = Field(default=0.0, description='The temperature to use for sampling.')
    top_k: int | GraphNode | tuple[GraphNode, str] = Field(default=50, description='The number of highest probability tokens to keep for top-k sampling.')
    top_p: float | GraphNode | tuple[GraphNode, str] = Field(default=0.95, description='The cumulative probability cutoff for nucleus/top-p sampling.')
    keep_alive: int | GraphNode | tuple[GraphNode, str] = Field(default=300, description='The number of seconds to keep the model alive.')
...
class SummarizeChunks(GraphNode):
    ...
    model: types.LlamaModel | GraphNode | tuple[GraphNode, str] = Field(default=types.LlamaModel(type='llama_model', name='', repo_id='', modified_at='', size=0, digest='', details={}), description='The Llama model to use for summarization.')
